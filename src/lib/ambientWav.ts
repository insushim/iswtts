...
// [주파수Hz, 진폭] — 합 피크 ≈ 0.96, 마스터 게인으로 여유 확보.
const PARTIALS: Array<[number, number]> = [
  [108, 0.42], // 아래 2옥타브 — 따뜻한 저음
  [216, 0.26], // 아래 1옥타브
  [432, 0.14], // 기준음
  [432.125, 0.14], // 살짝 디튠 → 0.125Hz 맥놀이(루프당 1회, 심리스)
];
const MASTER_GAIN = 0.7; // 파일 피크 ≈ 0.67 (재생 볼륨으로 추가 감쇠)
const LFO_HZ = 0.125; // 느린 스웰 — 루프당 1회
const LFO_DEPTH = 0.18; // 0.82 .. 1.00 사이로 진폭 흔들기
